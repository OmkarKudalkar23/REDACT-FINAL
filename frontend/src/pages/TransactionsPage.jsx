...
const TransactionsPage = () => {
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-x-hidden bg-black">
      ...
      {/* Hero Section */}
      <div className="transactions-hero relative min-h-screen w-screen flex items-center justify-center px-5 sm:px-10 pt-20">
      ...
      <section className="relative py-20 px-5 sm:px-10 border-t border-blue-900/30">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: "📊", title: "Detailed Reports", description: "Get comprehensive spending insights" },
              { icon: "🔍", title: "Smart Search", description: "Find transactions instantly" },
              { icon: "📈", title: "Trends", description: "Visualize your spending patterns" },
            ].map((feature, idx) => (
              <div
                key={idx}
      ...
      <section className="relative py-20 px-5 sm:px-10">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="border-hsla rounded-lg p-6 bg-gradient-to-br from-red-900/20 to-red-900/10 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            {filteredTransactions.length > 0 ? (
              filteredTransactions.map((transaction) => (
                <div
                  key={transaction.id}
                  className="transaction-item border-hsla rounded-lg p-6 bg-gradient-to-r from-blue-900/10 to-purple-900/10 backdrop-blur-sm hover:from-blue-900/20 hover:to-purple-900/20 transition-all duration-300"
                >
